...
require 'speaker_controller'

# Re-raise errors caught by the controller.
class SpeakerController; def rescue_action(e) raise e end; end

class SpeakerControllerTest < Test::Unit::TestCase
  fixtures :speeches

  def setup
    @controller = SpeakerController.new
